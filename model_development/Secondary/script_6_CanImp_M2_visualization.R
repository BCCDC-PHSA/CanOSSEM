######################################################################
# Purpose: Secondary CanOSSEM viz
# Author: namanpaul
...
load('path/M1_prediction_set_with_predictions.RData')

# read the var desc file
var_desc <- read_csv("model_development/retrain_CanOSSEM_with_2023/var_desc.csv")
...
load('G:/76_CanOSSEM_retrain/M1/Secondary_ranger_importance.RData')



load("C:/Users/naman/OneDrive/Secondary_ranger_importance.RData")
