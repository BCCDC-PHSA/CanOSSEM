######################################################################
# Purpose: Secondary CanOSSEM training
# Author: namanpaul
...
# ranger ------------------------------------
#load the dataset
load('path/CanOSSEM_training_set.RData')
...
#applying sample function
rows <- sample(nrow(training_set))

#saving the shuffled rows
training_set <- training_set[rows, ]
