#####################################################################
# Purpose: Process MERRA2 netcdf files 
# Author: namanpaul
...
#flx i/p path
flx_input_path <- "GMAO_MERRA2_FLX_input_path"

#slv i/p path
slv_input_path <- "GMAO_MERRA2_SLV_input_path"

#MERRA o/p files
MERRA_output_path <- "GMAO_MERRA2_output_path"
